...
import { ArrowRight, Brain, Code, Cpu, MessageSquare, Award, CheckCircle2, ChevronRight, BookOpen } from "lucide-react";
...
export default function Home() {
  return (
    <>
      <Navbar />
      <main className="page-container" style={{ paddingTop: 32, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        <section className="hero-section" style={{ padding: "32px 0" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
              ...
              <Link href="/setup" className="button-secondary" style={{ padding: "12px 24px", display: "flex", gap: 6 }}>
                <BookOpen size={16} /> Local Setup Guide
              </Link>
            </div>
